...
async def query_stock_news(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"查询股票新闻失败: {str(e)}")
...
async def query_news_advanced(request: NewsQueryRequest, current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"高级新闻查询失败: {str(e)}")
...
async def get_latest_news(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"获取最新新闻失败: {str(e)}")
...
async def search_news(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"新闻搜索失败: {str(e)}")
...
async def get_news_statistics(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"获取新闻统计失败: {str(e)}")
...
async def start_news_sync(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"启动新闻同步失败: {str(e)}")
...
async def sync_single_stock_news(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"同步股票新闻失败: {str(e)}")
...
async def cleanup_old_news(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"清理过期新闻失败: {str(e)}")
...
async def health_check():
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"健康检查失败: {str(e)}")
