...
class InternalMessageService:
    ...
    async def get_latest_messages(
        self, symbol: str = None, message_type: str = None, access_level: str = None, limit: int = 20
    ) -> list[dict[str, Any]]:
        """获取最新内部消息"""
    ...
    async def search_messages(
        self, query: str, symbol: str = None, access_level: str = None, limit: int = 50
    ) -> list[dict[str, Any]]:
        """全文搜索内部消息"""
        try:
            collection = await self._get_collection()
    ...
    async def get_research_reports(
        self, symbol: str = None, department: str = None, limit: int = 20
    ) -> list[dict[str, Any]]:
        """获取研究报告"""
        params = InternalMessageQueryParams(
            symbol=symbol,
    ...
    async def get_analyst_notes(self, symbol: str = None, author: str = None, limit: int = 20) -> list[dict[str, Any]]:
        """获取分析师笔记"""
        params = InternalMessageQueryParams(
            symbol=symbol,
