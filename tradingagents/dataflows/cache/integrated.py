...
class IntegratedCacheManager:
    ...
    def save_stock_data(
        self, symbol: str, data: Any, start_date: str = None, end_date: str = None, data_source: str = "default"
    ) -> str:
        """
        保存股票数据到缓存
    ...
    def find_cached_stock_data(
        self, symbol: str, start_date: str = None, end_date: str = None, data_source: str = "default"
    ) -> str | None:
        """
        查找缓存的股票数据
    ...
    def is_fundamentals_cache_valid(self, symbol: str, data_source: str = None, max_age_hours: int = None) -> bool:
        """
        检查基本面缓存是否有效
