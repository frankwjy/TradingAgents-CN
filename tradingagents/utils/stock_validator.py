...
class StockDataPreparer:
    ...
    def prepare_stock_data(
        self, stock_code: str, market_type: str = "auto", period_days: int = None, analysis_date: str = None
    ...
    def _trigger_data_sync_sync(self, stock_code: str, start_date: str, end_date: str) -> dict:
        ...
        try:
            ...
            return {"success": False, "message": f"同步失败: {str(e)}", "synced_records": 0, "data_source": None}
...
def prepare_stock_data(
    stock_code: str, market_type: str = "auto", period_days: int = None, analysis_date: str = None
) -> StockDataPreparationResult:
    """
    便捷函数：预获取和验证股票数据
